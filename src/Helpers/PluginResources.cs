namespace Loupedeck.HapticWebPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.HapticWebPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.HapticWebPlugin.Resources.Resource.txt`.
